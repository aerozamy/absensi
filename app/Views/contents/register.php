                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-row justify-content-between">
                                    <div class="col-6">
                                        <label>Password <i class="fa fa-eye mx-2"></i></label>
                                        <input class="au-input au-input--full" type="password" name="password" placeholder="Password">
                                    </div>
                                    <div class="col-6">
                                        <label>Konfirmasi</label>
                                        <input class="au-input au-input--full" type="password" name="password" placeholder="Konfirmasi">
                                    </div>
                                </div>
                                <button class="au-btn au-btn--block au-btn--green m-b-20 mt-3" type="submit">DAFTAR</button>
                            </form>
                            <hr>
